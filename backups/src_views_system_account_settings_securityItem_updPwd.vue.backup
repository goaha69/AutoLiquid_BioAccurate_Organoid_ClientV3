<template>
  <a-modal
    ...
    <a-form :form="formUpdPwd">
      <a-form-item label="原密:" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
        <a-input
          placeholder="请输入原密码"
          type="password"
          v-decorator="['password', {rules: [{required: true, message: '请输入原密码'}]}]" ></a>
      </a-form-item>
      <a-form-item label="新密:" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
        <a-input
          placeholder="请输入新密码"
          type="password"
      ...
      <a-form-item label="重复新密:" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback>
        <a-input
