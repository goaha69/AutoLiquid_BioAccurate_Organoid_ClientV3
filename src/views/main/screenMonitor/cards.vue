<template>
  <div id="cards">
    <div class="card-item" v-for="(card, i) in cards" :key="card.title">
      ...
      <dv-charts class="ring-charts" :option="card.ring" ></dv>
      <div class="card-footer">
        <div class="card-footer-item">
          <div class="footer-title">累计金额</div>
          <div class="footer-detail">
            <dv-digital-flop  config="card.total" style="width: 70%;height : 35px;" ></dv>
          </div>
        </div>
        <div class="card-footer-item">
          <div class="footer-title">巡查病害</div>
          <div class="footer-detail">
            <dv-digital-flop  config="card.num" style="width: 70%;height : 35px;" ></dv>
          </div>
        </div>
      </div>
    </div>
