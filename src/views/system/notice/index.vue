<template>
  <div>
    ...
    <a-card :bordered="false">
      ...
      >
        <template #operator v-if="hasPerm('sysNotice:add')">
          <a-button @click="$refs.addForm.add()" ><template #icon><plus-outlined ></plus-outlined></template type="primary" v-if="hasPerm('sysNotice:add')" >新增公告</a-button>
        </template>
        ...
        <template #action="{ text, record }">
          <div v-if="record.status == 0">
            ...
            <a-divider type="vertical" v-if="hasPerm('sysNotice  detail') & hasPerm('sysNotice : edit')"></a>
            <a v-if="hasPerm('sysNotice:edit')" @click="$refs.editForm.edit(record)">编辑</a>
            <a-divider type="vertical" v-if="hasPerm('sysNotice  edit') & hasPerm('sysNotice : changeStatus')"></a>
          ...
          <div v-if="record.status == 1">
            <a v-if="hasPerm('sysNotice:detail')" @click="$refs.detailForm.detail(record)">查看</a>
            <a-divider type="vertical" v-if="hasPerm('sysNotice  detail') & hasPerm('sysNotice : changeStatus')"></a>
          ...
          <div v-if="record.status == 2">
            <a v-if="hasPerm('sysNotice:detail')" @click="$refs.detailForm.detail(record)">查看</a>
            <a-divider type="vertical" v-if="hasPerm('sysNotice  detail') & hasPerm('sysNotice : delete')"></a>
      ...
      <add-form ref="addForm" @ok="handleOk" v-if="hasPerm('sysNotice:add')"></add>
      <edit-form ref="editForm" @ok="handleOk" v-if="hasPerm('sysNotice:edit')"></edit>
      <detail-form ref="detailForm" @ok="handleOk" v-if="hasPerm('sysNotice:detail')"></detail>
      <div ref="editor"></div>
    </a-card>
  </div>
</template>
