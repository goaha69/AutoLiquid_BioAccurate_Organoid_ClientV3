    ...
    <a-spin :spinning="formLoading">
      <a-form :form="form">
        ...
        <a-form-item
          ...
          has-feedback
        >
          <a-input placeholder="请输入唯一编码" :disabled="editDisabled" v-decorator="['code', {rules: [{required: true, message: '请输入唯一编码'}]}]" ></a>
        </a-form-item>
        <a-form-item
          label="系统参数"
          :labelCol="labelCol"
        ...
        <a-form-item
          ...
          has-feedback
        >
          <a-select :disabled="editDisabled" style="width: 100%" placeholder="请选择所属分:" v-decorator="['groupCode', {rules: [{ required: true, message: '请选择取所属分类!' }]}]" >
