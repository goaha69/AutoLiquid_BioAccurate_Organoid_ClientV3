<template>
  <a-modal title="新建文件:" :width="600" :open="visible" :confirmLoading="confirmLoading" @ok="handleSubmit"
    @cancel="handleCancel">
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="名称" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback="">
          <a-input placeholder="请输入名'" v-decorator="['name',{ initialValue:'新建文件',rules: [{ required: true, message: '请输入名'}]}]" ></a>
        </a-form-item>
        <a-form-item label="标签" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback="">

          <a-select style="width: 100%" placeholder="请输入标 : " v-decorator="['label']">
        ...
        <a-form-item label="备注" :labelCol="labelCol" :wrapperCol="wrapperCol" has-feedback="">
          <a-input placeholder="请输入备注" v-decorator="['remark']" ></a>
        </a-form-item>
      </a-form>
    </a-spin>
  </a-modal>
