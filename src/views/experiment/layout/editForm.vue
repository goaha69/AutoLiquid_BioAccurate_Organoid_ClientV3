  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        exp_layout_getShippingSpaces(dd).then((res) => {
          ...
          if (res.success) {
            ...
            console.log('========exp_layout_getShippingSpaces==========')
            console.log(this.shippingSpaces)

            this.shippingSpaces.forEach(element => {
      ...
      handleSubmit () {
        ...
        exp_layout_edit(this.attributeData).then((res) => {       
          if (res.success) {
            this.$message.success('༭ɹ')            
            this.$emit('ok', this.attributeData.id)
            this.handleCancel()
          } else {
